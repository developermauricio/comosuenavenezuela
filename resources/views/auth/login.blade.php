        ...
        <div class="content-body">
            ...
            <div class="auth-wrapper auth-v2">
                <div class="auth-inner row m-0">
                    ...
                    <!-- /Brand logo-->
                    <!-- Left Text-->
                    <div class="container-auth-banner">
                    ...
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5" style="margin-top: -12rem">
                        ...
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            <div role="alert" aria-live="polite" aria-atomic="true" class="alert alert-success">
                                <div class="alert-body text-justify" id="text-alert-account" style="display: none">Su
                                    cuenta ha sido creada existosamente. Hemos enviado un correo electrónico
                            ...
                            <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('email') @enderror" id="login-email" type="text"
                                           name="email"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-merge form-password-toggle">
                                        <input class="form-control @error('password')@enderror form-control-merge "
                                               id="login-password"
